...
| `p-admin-members.md`                                          | `/p/admin` → Участники list plus member create/edit/detail and nested aliases                                    | `src/app/(platform)/p/admin/members/**`    | wireframe | **original** — verbatim described-layout pick from owner Антон, 2026-08-29, recorded on #316: option A, profile left + aliases right, stacking on narrow viewports. The list layout remains `p-admin-shell.html`; the look remains the accepted `system: shadcn/ui via ui.refine.dev @ default neutral theme` row above. **Design-fidelity: GO — Anton Sidorov, 2026-08-29**                                                                                                                                                                                                                                   | #316     |
