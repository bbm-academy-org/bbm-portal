...
| `p-launcher.html`                                             | `/p` home launcher (member-facing app catalogue)                                                                  | `src/app/(platform)/p/page.tsx`, `src/app/(platform)/p/*.css` | wireframe | **original** — static-HTML wireframe authored by the Claude lead session for #311 Stage A (option "launcher-a", flat uniform grid); owner pick by Антон, 2026-08-25, recorded in #314                                                                                                                                                                                                                                                                                                                                                                                      | #314     |
