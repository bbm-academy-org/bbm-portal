...
| `p-admin-hours.md`                                            | `/p/admin` → Часы: periods, rates and grades, export, and Mattermost publication                                  | `src/app/(platform)/p/admin/hours/**`      | wireframe | **original** — verbatim described-layout pick from owner Anton Sidorov, 2026-08-30, recorded on #317: option A, four separate calm resource/action pages. The shell remains `p-admin-shell.html`; the look remains the accepted `system: shadcn/ui via ui.refine.dev @ default neutral theme` row above. **Design-fidelity: GO — Anton Sidorov, 2026-08-30**                                                                                                                                                                                                                                                      | #317     |
