...
ALTER TABLE "core"."finance_purpose_proposal" ADD CONSTRAINT "finance_purpose_proposal_intake_item_id_finance_intake_item_id_fk" FOREIGN KEY ("intake_item_id") REFERENCES "core"."finance_intake_item"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
-- Universal edit audit (spec 201): creation, resolution and dismissal are the
-- retained who/when/what record; EARS-526 needs no parallel journal.
