 ...
 *
 * Имена полей — snake_case: legacy-документ остаётся контрактом внутренней
 * migration/cutover-проверки (spec 124 EARS-11), хотя пользовательская
 * JSON-выгрузка удалена в #317. Это сохранённая форма данных, а не случайный
 * внутренний тип.
 */
