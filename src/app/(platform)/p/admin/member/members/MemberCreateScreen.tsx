...
import { CreateView } from '@/ui/refine-ui/views/create-view'
...
export function MemberCreateScreen() {
  ...
  return (
    <CreateView className="mx-auto w-full max-w-2xl">
