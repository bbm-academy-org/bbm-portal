...
/**
 * В отличие от цепочки 70 млн → 3,5 млн → 9,5 млн выше (она из спеки §8.1
 * дословно), сценарий ниже — СКОНСТРУИРОВАННЫЙ: 3% от 100 млн ÷ 5000. 600 ₽
 * названы эталонным примером трека инвестора в плане презентационной системы
 * (репо bbm, docs/superpowers/plans/2026-08-11-finmodel-presentation-system.md,
 * задача 13), но это модельное значение на модельных входах, а не обещанная
 * каноном цифра: поменяются входы — поменяется и оно.
 */
