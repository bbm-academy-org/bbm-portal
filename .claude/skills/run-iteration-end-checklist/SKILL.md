...
| Layer                                                                                                                       | Owns                                                                                                                                                                                    |
| --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pnpm pr:land <PR>` (`tools/gh/pr-land.mjs`)                                                                                | PR open / not draft / no conflict / carries `Closes #N`; a `VERDICT: APPROVE` review newer than head; every check-run green on the current head SHA; then merge, board `Done`, teardown |
