...
const formatExtensions = ['ts', 'tsx', 'mjs', 'js', 'css', 'md', 'json', 'yml', 'yaml']
const workflowExtensions = ['yml', 'yaml']
const rootExtensions = ['md', 'json', 'mjs', 'js']
const stylelintDirectory = 'src'

export const prettierGlobs = [
  ...formatDirectories.map((directory) => `${directory}/**/*.{${formatExtensions.join(',')}}`),
...
export const createLintStagedConfig =
