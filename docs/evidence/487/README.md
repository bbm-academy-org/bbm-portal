...
| ----------------------------------------------- | ------------ | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `01-before-requests-select-times-new-roman.png` | 3000         | **before**      | `/p/finance/requests`, the sheet of «Заявка №69» open, its «Подтверждающий документ» type select OPEN. The list (Счёт / Чек / Инвойс / …) renders in Times New Roman, with no popover background, ring or radius — it is outside every `[data-bbm-ui]` subtree. This is what the owner saw on 2026-09-15.                           |
...
**DoD check.** All four frames were reviewed: none is red, error-stuck or
skeleton-stuck.
