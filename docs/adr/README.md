...
| ADR-004 | [Platform persistence foundation — the `platform` database, drizzle, and our own migration pipeline](./004-platform-persistence-foundation.md) | Accepted 2026-08-11, amended A1 2026-08-21, A2 2026-09-22 | This directory                                                                               |
