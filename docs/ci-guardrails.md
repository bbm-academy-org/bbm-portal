...
**EARS-20 asks for a batch-job step; ci.yml has no batch job.** The clause's wiring sentence
(«a step carrying `continue-on-error: true` plus the §8 batch-job outcome aggregation») was
written against the batch shape #205/PR #206 attempted and never landed. This file's job
