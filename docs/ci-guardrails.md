...
| _instruction-budget_    | _CLI only_           | _the guard landed in #139 as a CLI guard (§6.1, `tools/lint/instruction-budget-lint.mjs`); the `ci.yml` wiring stays with task 7.4 (#135), which fills this row_                           | WARN      | —          | row filled at landing                                                                                                                                                           |
