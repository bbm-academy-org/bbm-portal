...
| **ears-naming**         | `ci.yml`              | a test title that ATTEMPTS the `EARS-N:` prefix and misspells it (`ears-3:`, `EARS3:`, `EARS-3` with no colon, `EARS 3:`) — the traceability grep then silently misses it                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | WARN                           | 2026-08-05 | **held at WARN on 2026-09-02** (#438); guard tranche 2 (#157). The §4 window was clean, but the guard's own header declares an unresolved FALSE-BLOCK class and defers it to exactly that review: `ATTEMPT_RE` fires on any title merely STARTING with the word EARS, so `describe('EARS adoption record')` reads as a botched id. Narrowing it is a substantive rule change and restarts the §4 clause-2 clock, so it was not done in the promotion PR. **New condition: narrow `ATTEMPT_RE` (#447), then a 4-week clean window — earliest 2026-09-30**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
