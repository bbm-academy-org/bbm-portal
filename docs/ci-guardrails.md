...
| **stage-b**             | `pr-body-guards.yml`  | a UI diff (non-test `*.tsx` / `*.css` under `src/`) with no recorded `Stage-B:` verdict in the PR body or a linked-issue comment                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | **BLOCK**                      | 2026-08-05 | **promoted 2026-09-02** (#438). Guard authored in task 7.7 (#138) and always invoked with `--severity block`, so §4 clause 1 was satisfied throughout the soak. All three recorded defects are false PASSES — an asset-only visual change is invisible to the path-only classifier (#230), a parent-comment GO satisfies every later slice (#299), and the GO/PLACEHOLDER ordering could accept an unfilled template (#359) — so it can miss a UI diff but cannot invent one                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
