...
| **interaction-states**  | `pr-body-guards.yml`  | the states half of the same diff: an added opening tag carrying `onClick` under `src/app/(platform)` with no hover affordance, no `focus-visible:` ring, or — when it carries a `disabled` attribute — no `disabled:` treatment. A capitalised tag is a component and is skipped: the kit primitives own these states, and a component whose import is outside the diff cannot be classified from the diff alone. Inline escape: `interaction-states-ok: <reason>`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | WARN                           | 2026-09-03 | earliest 2026-10-01, §4 clauses; same WARN reasoning as `primitives-first` above. Ported from ds-platform `tools/lint/interaction-states-lint.ts` in #435, whose measurement is the motive: `onClick` 27 times against 6 `hover:` occurrences under `src/app/(platform)`, and `cursor-pointer` zero times in `src`. The original's layer-1 (`globals.css` base reset) and `interactiveBase`-fragment halves are DROPPED, not ported — this repo's kit is stock shadcn/ui via Refine (#360/#434) and has neither, so porting them would invent a contract nobody agreed to                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
