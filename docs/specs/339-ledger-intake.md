...
| purpose proposals                       | any platform member from the request form (EARS-526)                                                                                    | the cabinet QUEUE — admin, and the proposer sees own (EARS-526); the PENDING proposal TEXT of a request on the list — every platform member, at EARS-534's open-book scope (owner decision, Антон, 2026-09-16, #480) | admin resolves into a real purpose                                                          | admin dismisses; the proposal record stays                                                            |
